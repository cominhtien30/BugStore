            ...
            <?php 
              ...
              ?>
                    ...
                    <center>
                        ...
                        <?php 
                                //Đếm trang
                            $all_product=$pro->Show_All_Page();
                            $count_page=mysqli_num_rows($all_product);
                            $quanlity_button=ceil($count_page/6) ;
                            $i=1;

                            for($i=1;$i<=$quanlity_button;$i++){
                        ...
                        <a href="product.php?page=<?php echo $next ?>"><i class="fa fa-long-arrow-right"></i></a>
                    </div>
                    </center>
                </div>
            </div>
